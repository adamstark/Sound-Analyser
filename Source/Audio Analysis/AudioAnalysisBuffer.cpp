...
//==============================================================================
AudioAnalysisBuffer::AudioAnalysisBuffer (int bufferSize_) : bufferReady(false), numSamplesCollected(0)
{
...
//==============================================================================
void AudioAnalysisBuffer::addNewSamplesToBuffer (float* samples,int numSamples)
{
    bufferReady = false;
...
//==============================================================================
int AudioAnalysisBuffer::getBufferSize()
{
    return bufferSize;
}

//==============================================================================
bool AudioAnalysisBuffer::isReady()
{
    return bufferReady;
}
